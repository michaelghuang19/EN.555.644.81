...
\subsection*{(a)}
What is \(N'(x)\)? \\ \\
\(N(x)\) represents the cumulative probability that that a variable within a standardized normal distribution will be less than \(x\), i.e. the cdf, \(N'(x)\) is the derivative of the cdf, i.e. the pdf or just the probability density for the variable being equal to \(x\). More explicitly, this would just be the function \(\frac{1}{\sqrt{2\pi}} e^{-\frac{x^2}{2}}\) which is very familiar by now. 
...
\]
Since \(d_1 = d_2 + \sigma \sqrt{T - t}\), we know that 
\[
  N'(d_1) = N'(d_2 + \sigma \sqrt{T-t})
\]
\[
  = \frac{1}{\sqrt{2\pi}} e^{-\frac{d_2^2}{2} - \sigma d_2 \sqrt{T-t} - \frac{1}{2} \sigma^2 (T-t)}
\]
\[
  = N'(d_2) e^{ - \sigma d_2 \sqrt{T-t} - \frac{1}{2} \sigma^2 (T-t)}
\]
Plugging in the given values for \(d_2\):
\[
  = N'(d_2) e^{ - \sigma \sqrt{T-t} \cdot \frac{\ln(S / K) + (r - \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}  - \frac{1}{2} \sigma^2 (T-t)}
\]
\[
  = N'(d_2) e^{ - \ln(S / K) - (r - \sigma^2 / 2)(T - t) - \frac{1}{2} \sigma^2 (T-t)}
\]
\[
  = N'(d_2) e^{ - \ln(S / K) - r(T - t)}
\]
\[
  N'(d_1) = N'(d_2) \frac{K}{S}e^{-r(T - t)} 
\]
\[
  S N'(d_1) = Ke^{-r(T - t)} N'(d_2)
\]
which is precisely what we sought to find. 
...
\]
\[
  \frac{\partial d_1}{\partial S} = \frac{\partial}{\partial S} \frac{\ln(S / K) + (r + \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}
\]
\[
  = \frac{\partial}{\partial S} \frac{\ln(S) - \ln(K) + (r + \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}
\]
\[
  \frac{\partial d_1}{\partial S} = \frac{1 - 0 + 0}{S \sigma \sqrt{T - t}} = \boxed{\mathbf{\frac{1}{S \sigma \sqrt{T - t}}}}
\]
For \(d_2\):
\[
  d_2 = \frac{\ln(S / K) + (r - \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}
\]
\[
  \frac{\partial d_2}{\partial S} = \frac{\partial}{\partial S} \frac{\ln(S / K) + (r - \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}
\]
\[
  = \frac{\partial}{\partial S} \frac{\ln(S) - \ln(K) + (r - \sigma^2 / 2)(T - t)}{\sigma \sqrt{T - t}}
\]
\[
  \frac{\partial d_2}{\partial S} = \frac{1 - 0 + 0}{S \sigma \sqrt{T - t}} = \boxed{\mathbf{\frac{1}{S \sigma \sqrt{T - t}}}}
\]
...
Differentiating:
\[
  \frac{\partial c}{\partial t} = SN'(d_1) \frac{\partial d_1}{\partial t} - Ke^{-r(T-t)} \cdot r \cdot N(d_2) - Ke^{-r(T-t)} \cdot N'(d_2) \frac{\partial d_2}{\partial t}
\]
We previously showed that \(SN'(d_1) = Ke^{-r(T-t)}N'(d_2)\), so substitute accordingly:
\[
  = SN'(d_1) \frac{\partial d_1}{\partial t} - r Ke^{-r(T-t)} N(d_2) - S N'(d_1) \frac{\partial d_2}{\partial t}
\]
\[
  = SN'(d_1) (\frac{\partial d_1}{\partial t} - \frac{\partial d_2}{\partial t}) - r Ke^{-r(T-t)} N(d_2)
\]
Looking at the first term, we can derive this partial derivative as well; we know that 
\[
  d_2 = d_1 - \sigma \sqrt{T}
\]
\[
  \sigma \sqrt{T} = d_1 - d_2 
\]
In our case, \(T = T-t\). Now differentiating:
\[
  \frac{\partial}{\partial t} \sigma \sqrt{T - t} = \frac{\partial d_1}{\partial t} - \frac{\partial d_2}{\partial t}
\]
\[
  \frac{\partial d_1}{\partial t} - \frac{\partial d_2}{\partial t} = \sigma \cdot (T - t)^{-\frac{1}{2}} \cdot -\frac{1}{2}
\]
\[
...
\[
  \boxed{\mathbf{\frac{\partial c}{\partial t} = - \frac{SN'(d_1) \sigma}{2 \sqrt{T - t}} - r Ke^{-r(T-t)} N(d_2)}}
\]
...
Differentiating:
\[
  \frac{\partial c}{\partial S} = N(d_1) + S N'(d_1) \frac{\partial d_1}{\partial S} - Ke^{-r(T-t)} N'(d_2) \frac{\partial d_2}{\partial S}
\]
We previously showed that \(SN'(d_1) = Ke^{-r(T-t)}N'(d_2)\), so substitute accordingly:
\[
  \frac{\partial c}{\partial S} = N(d_1) + S N'(d_1) \frac{\partial d_1}{\partial S} - S N'(d_1) \frac{\partial d_2}{\partial S}
\]
\[
  = N(d_1) + S N'(d_1) (\frac{\partial d_1}{\partial S} - \frac{\partial d_2}{\partial S})
\]
We also previously showed that \(\frac{\partial d_1}{\partial S} = \frac{\partial d_2}{\partial S} = \frac{1}{S \sigma \sqrt{T - t}}\), so substitute accordingly:
\[
  = N(d_1) + S N'(d_1) (\frac{1}{S \sigma \sqrt{T - t}} - \frac{1}{S \sigma \sqrt{T - t}})
\]
\[
  \boxed{\mathbf{\frac{\partial c}{\partial S} = N(d_1)}}
\]

\subsection*{(f)}
Show that \(c\) satisfies the Black-Scholes-Merton differential equation. \\ \\
We aim to show that 
\[
  \frac{\partial f}{\partial t} + rS\frac{\partial f}{\partial S} + \frac{1}{2}\sigma^2 S^2 \frac{\partial^2 f}{\partial S^2} = rf
\]
where \(f = c\). We've already found \(\frac{\partial c}{\partial t}\) and \(\frac{\partial c}{\partial S}\), let's find \(\frac{\partial^2 c}{\partial S^2}\):
\[
  \frac{\partial^2 c}{\partial S^2} = \frac{\partial }{\partial S} N(d_1)
\]
\[
  \frac{\partial^2 c}{\partial S^2} = N'(d_1) \frac{\partial d_1}{\partial S}
\]
\[
  \frac{\partial^2 c}{\partial S^2} = \frac{N'(d_1)}{S \sigma \sqrt{T - t}}
\]
Let's now substitute accordingly:
\[
  \frac{\partial c}{\partial t} + rS\frac{\partial c}{\partial S} + \frac{1}{2}\sigma^2 S^2 \frac{\partial^2 c}{\partial S^2}
\]
\[
  = - \frac{SN'(d_1) \sigma}{2 \sqrt{T - t}} - r Ke^{-r(T-t)} N(d_2) + r S N(d_1) + \frac{1}{2}\sigma^2 S^2 \cdot \frac{N'(d_1)}{S \sigma \sqrt{T - t}}
\]
\[
  = - \frac{SN'(d_1) \sigma}{2 \sqrt{T - t}} - r Ke^{-r(T-t)} N(d_2) + r S N(d_1) + \frac{SN'(d_1)\sigma}{2\sqrt{T - t}}
\]
\[
  = - r Ke^{-r(T-t)} N(d_2) + r S N(d_1) 
\]
\[
  = r (S N(d_1)  - Ke^{-r(T-t)} N(d_2))
\]
\[
  = rc
\]
...
We know that \( c = SN(d_1) - Ke^{-r(T-t)} N(d_2) \). As \(t\) approaches \(T\): \\
- If \(S > K\): We have \(\ln(\frac{S}{K}) > 0\) while \(\sigma \sqrt{T - t}\) approaches 0, so \(d_1\) and \(d_2\) approach infinity. Therefore \(N(d_1)\) and \(N(d_2)\) approach 1. \(c\) essentially becomes \(S - K\), which given our initial assumption, is positive and therefore greater than 0. \boxed{\textbf{The condition holds}}. \\
- If \(S < K\): We have \(\ln(\frac{S}{K} < 0)\) while \(\sigma \sqrt{T - t}\) approaches 0, so \(d_1\) and \(d_2\) approach negative infinity. Therefore \(N(d_1)\) and \(N(d_2)\) approach 0. \(c\) therefore basically just becomes 0, which given our initial assumption, would be greater than \(S - K\), which would be negative, so \boxed{\textbf{the condition also holds}}.
...
To calculate the stock price volatility, we take the weekly log returns \(u_i = \ln(\frac{S_i}{S_{i-1}})\). We can then take the weekly standard deviation and annualize to 52 weeks, and then take the standard error accordingly. I did this in python to make it easier:
\begin{verbatim}
import numpy as np
...
\begin{verbatim}
> python 15_26.py
Weekly returns SD: 0.027841997134013863
Annual volatility estimate: 0.20077149655601684
Standard error of estimate: 0.0366556925226004
\end{verbatim}
So we see that the annual volatility estimate is approximately \boxed{\textbf{20.08\%}} and the standard error of that estimate is approximately \boxed{\textbf{3.67\%}}.
